...
class Application_Form_Fireplace extends Zend_Form
{

    public function init()
    {
       $this-> setName('Fireplace');
...
//               -> addValidator ('NotExists', false, $productimages );
       ...
       $this -> addElements(array($id, $category_id, $name, $item_code, $price, $images, $size, $weight, $color, $submit));
    }
