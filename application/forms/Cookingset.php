...
class Application_Form_Cookingset extends Zend_Form
{

    public function init()
    {
       $this-> setName('Cookingset');
...
//               -> addValidator ('NotExists', false, $productimages );
       ...
       $this -> addElements(array($id, $category_id, $name, $item_code, $type, $price, $images, $size, $length, $width, $thickness, $weight, $submit));
    }
