...
class Application_Form_Umbrela extends Zend_Form
{

    public function init()
    {
       $this-> setName('Umbrela');
...
//               -> addValidator ('NotExists', false, $productimages );
       ...
       $this -> addElements(array($id, $category_id, $name, $item_code, $type, $price, $images, $size, $weight,$material, $color, $submit));
    }
